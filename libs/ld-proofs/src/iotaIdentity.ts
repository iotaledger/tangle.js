...
let VerificationMethodObj: typeof Vm = Vm;
...
if (isBrowser()) {
    ...
    VerificationMethodObj = require(requirePath).VerificationMethod;
...
export type VerificationMethod = InstanceType<typeof VerificationMethodObj>;
export { Document, Client, Config, Network };
